  ...
  return <main className="bg-gray-50">
    ...
    <div className="mx-auto container p-6 lg:flex lg:items-center lg:justify-between">
      ...
      <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
        <Lottie animationData={cactusAnimation} lottieRef={lottieRef as any} loop={false} />
      </div>
    </div>
    ...
    <div className="container mx-auto bg-white py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="sm:text-center">
          <h2 className="text-lg font-semibold leading-8 text-amber-600">Transactions</h2>
        ...
        <div className="mt-20 max-w-lg sm:mx-auto md:max-w-none">
          <div className="grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-x-12 md:gap-y-16">
            <Feature name="Grows Quickly" description='Grows incredibly fast'>
            ...
            <Feature name="Wireless Operation" description='Grows incredibly fast'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <Feature name="Security First" description='Grows incredibly fast'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
